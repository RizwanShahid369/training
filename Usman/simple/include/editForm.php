...
<form action="methods.php" method="post">
    ...
    ?>
     Name<br>
    <input type="text" name="class" value=<?php echo htmlentities($name); ?>><br><br>
    Father Name
    <input type="text" name="class" value=<?php echo htmlentities($fname); ?>><br><br>
    Date of Birth
    <input type="text" name="class" value=<?php echo htmlentities($dob); ?>><br><br>
    class<br>
    <input type="text" name="class" value=<?php echo htmlentities($class); ?>><br><br>
    Address<br>

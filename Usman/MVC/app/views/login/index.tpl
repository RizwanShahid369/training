...
<script src="/m_v_c/app/views/layout/bower_components/raphael/raphael-min.js"></script>
<script src="/m_v_c/app/views/layout/bower_components/morrisjs/morris.min.js"></script>
<script src="/m_v_c/app/views/layout/js/morris-data.js"></script>
